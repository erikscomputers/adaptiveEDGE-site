...
const HomePage = () => {
  ...
  className="inline-flex items-center justify-center text-xl md:text-2xl font-semibold px-8 py-5 rounded-xl bg-secondary text-white hover:bg-accent/90 transition-all duration-200 shadow-lg hover:shadow-xl"
>
  View Corporate Solutions
  <ArrowRight className="ml-3 h-6 w-6 text-white transition-transform duration-200 group-hover:translate-x-1" />
</Link>
                </Button>
              </motion.div>
